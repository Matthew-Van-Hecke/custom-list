...
namespace customListTest
{
    ...
    public class CustomListTestMethods
    {
        ...
        //}
        [TestMethod]
        public void CopyArray_FromLengthOfTwoToLengthOfFour_ValueAtIndexOneIsSameForBothArrays()
        {
            //Arrange
            CustomList<int> customList = new CustomList<int>();
            int[] arrayToBeCopiedFrom = new int[] { 54, 37 };
            int[] arrayToBeCopiedTo = new int[4];
            int expected = 37;
            //Act
            customList.CopyArray(arrayToBeCopiedFrom, arrayToBeCopiedTo);
            //Assert
            Assert.AreEqual(expected, arrayToBeCopiedTo[1]);
        }
    }
}
